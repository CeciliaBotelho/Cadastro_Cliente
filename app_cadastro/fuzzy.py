...
def calcular_credito(idade, renda_mensal):
    ...
    renda_mensal_fuzzy['baixa'] = fuzz.trimf(renda_mensal_fuzzy.universe, [0, 0, 5000])
    renda_mensal_fuzzy['media'] = fuzz.trimf(renda_mensal_fuzzy.universe, [2000, 7500, 20000])
    renda_mensal_fuzzy['alta'] = fuzz.trimf(renda_mensal_fuzzy.universe, [15000, 30000, 60000])
...
# Definindo as regras fuzzy
    regra1 = ctrl.Rule(idade_fuzzy['jovem'] & renda_mensal_fuzzy['alta'], credito['alto'])
    regra2 = ctrl.Rule(idade_fuzzy['medio'] & renda_mensal_fuzzy['alta'], credito['medio'])
    regra3 = ctrl.Rule(idade_fuzzy['idoso'] & renda_mensal_fuzzy['alta'], credito['medio'])

    regra4 = ctrl.Rule(idade_fuzzy['jovem'] & renda_mensal_fuzzy['media'], credito['medio'])
    regra5 = ctrl.Rule(idade_fuzzy['medio'] & renda_mensal_fuzzy['media'], credito['baixo'])
    regra6 = ctrl.Rule(idade_fuzzy['idoso'] & renda_mensal_fuzzy['media'], credito['baixo'])

    regra7 = ctrl.Rule(idade_fuzzy['jovem'] & renda_mensal_fuzzy['baixa'], credito['baixo'])
    regra8 = ctrl.Rule(idade_fuzzy['medio'] & renda_mensal_fuzzy['baixa'], credito['baixo'])
    regra9 = ctrl.Rule(idade_fuzzy['idoso'] & renda_mensal_fuzzy['baixa'], credito['baixo'])
    ...
    return simulacao.output['credito']